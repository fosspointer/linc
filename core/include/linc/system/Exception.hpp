...
#define LINC_EXCEPTION(message) linc::Exception(__FILE__, __LINE__, __FUNCTION__, std::string{message})
#define LINC_EXCEPTION_INVALID_INPUT(message) linc::Exception(__FILE__, __LINE__, __FUNCTION__, std::string{"Invalid input: "} + message + '.')
...
#define LINC_EXCEPTION_VARIABLE(variable, message) linc::Exception(__FILE__, __LINE__, __FUNCTION__, linc::Exception::variableExceptionMessage(linc::Exception::variableToPrintable(variable), #variable, LINC_EXCEPTION_TYPEOF(variable), message))
